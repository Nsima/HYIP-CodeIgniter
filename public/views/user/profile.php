            ...
            <div class="tab-content p-3">
                <div class="tab-pane active" id="profile">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <h6>Badges</h6>
                            <a href="javascript:void();" class="badge badge-dark badge-pill">first bonic coin</a>
                            <a href="javascript:void();" class="badge badge-dark badge-pill">first referral</a>
                            <a href="javascript:void();" class="badge badge-dark badge-pill">first sale</a>
                            <?php /*
                            <a href="javascript:void();" class="badge badge-success badge-pill">angularjs</a>
                            ...
                            */ ?>
                            <hr>
                            <span class="badge badge-primary"><i class="fa fa-user"></i> 50 Referrals</span>
                            <?php /*<span class="badge badge-success"><i class="fa fa-cog"></i> </span> */?>
                            <span class="badge badge-danger"><i class="fa fa-eye"></i> KYC Level 2</span>
                        </div>
                        <div class="col-md-12">
                            ...
                            <table class="table table-hover table-striped">
                                <tbody>                                    
                                    <tr>
                                        <td>
                                            <strong>Abby</strong> joined with your referral link
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <strong>You</strong> sold 20 Bonic Coins to <strong>Gerald</strong>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
